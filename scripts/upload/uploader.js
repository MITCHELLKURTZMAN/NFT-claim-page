...
async function test_upload(canisterId, identityName, dataPath) {
  ...
  const serviceActor = createActor(canisterId, {agent})

  let data = JSON.parse(fs.readFileSync(dataPath, 'utf8'));


  await serviceActor.setHolders(JSON.stringify(data))
  .then(_ => {
    console.log("OK")
  })
  .catch(e => {
...
test_upload(canisterId, identityName, jsonPath)
